...
plt.savefig('GNA_gradient.png', bbox_inches='tight')
plt.close(fig)
...
print ("perturb real images diff. in pred." + (pred_alternate - pred))
...
fig = plot(X_batch)
plt.savefig('GNA_X.png', bbox_inches='tight')
plt.close(fig)
...
plt.savefig('GNA_X_alternate.png', bbox_inches='tight')
plt.close(fig)
...
gradient_image = (gradient - np.min(gradient))/(np.max(gradient)-np.min(gradient))
fig = plot(gradient_image)
plt.savefig('GNA_noise_gradient.png', bbox_inches='tight')
plt.close(fig)
...
print ("perturb image of noise diff. in pred." + (pred_alternate - pred))
...
X_batch[X_batch<0.0] = 0.0
fig = plot(X_batch)
plt.savefig('GNA_noise_X.png', bbox_inches='tight')
plt.close(fig)
...
X_batch_modified[X_batch_modified<0.0] = 0.0
fig = plot(X_batch_modified)
plt.savefig('GNA_noise_X_alternate.png', bbox_inches='tight')
plt.close(fig)
...
plt.savefig('GNA_classes_700_0.3_0.003.png', bbox_inches='tight')
plt.close(fig)
...
plt.savefig('GNA_features_700_1_0.001.png', bbox_inches='tight')
plt.close(fig)
