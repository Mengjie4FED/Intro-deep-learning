...
from model import cifar10_conv_L8
...
for i in range(10000):
    ...
    accuracy_count += 1
    if i % 10 == 0:
        print('time: %f accuracy:%f (hidden layer: 8, keep prob: 0.4, with augmentation) ' % (float(time.time()-t),test_accuracy/accuracy_count))
        t = time.time()